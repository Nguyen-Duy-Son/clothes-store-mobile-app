import 'package:clothes_store_mobile_app/app/cubits/sign_in/sign_in_cubit.dart';
...
import '../../custom/widgets/animation_next_screen.dart';
...
class _SignInViewState extends State<SignInView> {
    ...
    if (mounted) {
      showDialog(
        ...
        builder: (BuildContext context) {
          return const AnimationNextScreen();
        },
      );
  ...
  void signIn() async {
    _emailController.text = "nguyenduyson28072003@gmail.com";
    _passwordController.text = "Son@28072003";
    context
        .read<SignInCubit>()
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    ...
                    borderSide:
                        const BorderSide(color: ColorConstants.neutralLight90),
                  ),
