...
class ShipTypeWidget extends StatefulWidget {
  const ShipTypeWidget({super.key, required this.checkOutState, required this.myCardState});
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    "${FunctionClass.formatDateTime(widget.checkOutState.shippings[index].timeStart)} - ${FunctionClass.formatDateTime(widget.checkOutState.shippings[0].timeEnd)} | ${widget.checkOutState.shippings[0].cost} \$",
                    style: TextStyleConstant.lightLight20.copyWith(
